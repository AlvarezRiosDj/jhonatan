                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="assets/admin/images/users/avatar-1.jpg" class="img-responsive rounded-circle" alt="user">
                                ...
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="assets/admin/images/users/avatar-2.jpg" class="img-responsive rounded-circle" alt="user">
                                        <div class="wid-u-info">
                                ...
                                <div class="card-box widget-user">
                                    <div>
                                        <img src="assets/admin/images/users/avatar-7.jpg" class="img-responsive rounded-circle" alt="user">
                                        <div class="wid-u-info">
