          ...
          <div class="col-sm-6 col-md-5 col-lg-4 col-xs-12">
            <div class="contactInfo">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h4 class="media-heading">Numero de Telefono</h4>
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <h4 class="media-heading">Nuestro Email</h4>
          ...
          <div class="col-sm-6 col-md-7 col-xs-12 col-lg-8">
            <div class="contactForm">
              <form action="" method="POST" role="form" class="form">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" id="" placeholder="Correo Electronico">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" id="" placeholder="Numero de celular">
                </div>
                <div class="form-group">
                  <textarea class="form-control" id="" placeholder="Escriba su mensaje aqui"></textarea>
                </div>
