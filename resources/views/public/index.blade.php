...
<head>
  ...
  <title>LuxuryExpeditions | Tour Agency</title>
...
<section class="bannercontainer">
  ...
  <div id="rev_slider_wrapper1" class="rev_slider_wrapper fullscreen-container" data-alias="christmas-snow-scene" data-source="gallery" style="background-color:transparent;padding:0px;">
    ...
    <div id="rev_slider_container" class="rev_slider custom_rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
      <ul>
        ...
        <li data-transition="parallaxvertical" >
          <!-- MAIN IMAGE -->
          <img src="{{ asset('assets/front/img/home/slider/slider-01.jpg') }}" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
          ...
          <!-- LAYER NR. 2 -->
            <div class="tp-caption tp-resizeme slide-layer-2" id="slide-layer-2"
              ...
              style="z-index: 1; text-transform: uppercase;">LuxuryExpeditions
    ...
    <li data-transition="parallaxvertical">
      <!-- MAIN IMAGE -->
      <img src="{{ asset('assets/front/img/home/slider/slider-02.jpg') }}" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
    ...
    <li data-transition="parallaxvertical">
      <!-- MAIN IMAGE -->
      <img src="{{ asset('assets/front/img/home/slider/slider-03.jpg') }}" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
    ...
    <li data-transition="parallaxvertical">
      <!-- MAIN IMAGE -->
      <img src="{{ asset('assets/front/img/home/slider/slider-04.jpg') }}" alt="slidebg1"   data-bgparallax="3" class="rev-slidebg" data-no-retina>
        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <div class="thumbnail deals">
              ...
              <a href="{{ url('tour') }}" class="pageLink"></a>
              ...
              <div class="caption">
                <h4><a href="{{ url('tour') }}" class="captionTitle">Suspendisse Blandit</a></h4>
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="thumbnail deals">
              ...
              <div class="caption">
                <h4><a href="{{ url('tour') }}" class="captionTitle">Suspendisse Eros Erat</a></h4>
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="thumbnail deals">
              ...
              <div class="caption">
                <h4><a href="{{ url('tour') }}" class="captionTitle">Quisque Placerat Nunc</a></h4>
          ...
          <div class="col-xs-12">
            <div class="media destinations">
              <a class="media-left" href="destination-cities.html">
                <img class="media-object" src="{{ asset('assets/front/img/home/destination.jpg') }}" alt="Destination">
              </a>
      ...
      <div class="container">
          ...
          <div class="col-xs-12">
            <div class="filter-container isotopeFilters">
              <ul class="list-inline filter">
                ...
                <li><a href="#" data-filter=".asia">Perú</a></li>
                <li><a href="#" data-filter=".america">Argentina</a></li>
                <li><a href="#" data-filter=".africa">Bolivia</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="row isotopeContainer">
            <div class="col-sm-4 isotopeSelector asia">
              <article class="">
                <figure>
                  <img src="{{ asset('assets/front/img/home/packages/packages-1.jpg') }}" alt="">
            ...
            <div class="col-sm-4 isotopeSelector america africa">
              <article class="">
                <figure>
                  <img src="{{ asset('assets/front/img/home/packages/packages-2.jpg') }}" alt="">
                  <h4>Maecenas Tour</h4>
                  <div class="overlay-background">
                    <div class="inner"></div>
                  </div>
            ...
            <div class="col-sm-4 isotopeSelector africa">
              <article class="">
                <figure>
                  <img src="{{ asset('assets/front/img/home/packages/packages-3.jpg') }}" alt="">
                  <h4>Lobortis Tour</h4>
                  <div class="overlay-background">
                    <div class="inner"></div>
                  </div>
            ...
            <div class="col-sm-4 isotopeSelector asia america">
              <article class="">
                <figure>
                  <img src="{{ asset('assets/front/img/home/packages/packages-4.jpg') }}" alt="">
            ...
            <div class="col-sm-4 isotopeSelector america">
              <article class="">
                <figure>
                  <img src="{{ asset('assets/front/img/home/packages/packages-5.jpg') }}" alt="">
                  <h4>Nullam Tour</h4>
                  <div class="overlay-background">
                    <div class="inner"></div>
                  </div>
            ...
            <div class="col-sm-4 isotopeSelector africa asia">
              <article class="">
                <figure>
                  <img src="{{ asset('assets/front/img/home/packages/packages-6.jpg') }}" alt="">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-xs-12">
          <div class="footerContent">
            ...
            <ul class="list-unstyled">
              <li><i class="fa fa-home" aria-hidden="true"></i>Av. Los Incas 158 - Cusco</li>
              <li><i class="fa fa-phone" aria-hidden="true"></i>[88] 657 524 332</li>
              <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailTo:info@star-travel.com">admin@LuXuryExpeditions.com</a></li>
            </ul>
          </div>
        </div>
        <div class="col-sm-3 col-xs-12">
